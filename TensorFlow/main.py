...
code_runner = tf.InteractiveSession()
...
# Define some functions to apply convolution and max pooling to improve our results
def conv2d(x, W):
...
code_runner.run(tf.global_variables_initializer())
...
print("test accuracy %g"%accuracy.eval(feed_dict={
    x: mnist.test.images, y: mnist.test.labels, keep_prob: 0.5}))
